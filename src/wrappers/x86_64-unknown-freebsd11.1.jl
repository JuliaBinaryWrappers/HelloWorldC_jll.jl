# Autogenerated wrapper script for HelloWorldC_jll for x86_64-unknown-freebsd11.1
export hello_world
...
function __init__()
    ...
    global hello_world_path = abspath(joinpath(artifact"HelloWorldC", hello_world_splitpath...))
